...
const checks = [
  ...
  ["action log filter state", "const [actionLogFilter,setActionLogFilter] = useState<'all'|'combat'|'loot'|'system'>('all')"],
  ["action log kind helper", "const actionLogKind = (line:string): 'combat'|'loot'|'system' => {"],
  ["action log filter UI", "className='dq-action-log-filters'"],
