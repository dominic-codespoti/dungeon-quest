...
const checks = [
  ...
  ["copy run link status confirms visual mode", "setStatus(`Run link copied (Visual: ${visualPreset}).`)"],
  ["copy create launch status confirms visual mode", "setStatus(`Create launch link copied (Visual: ${visualPreset}).`)"],
  ["copy last-run link status confirms visual mode", "setStatus(`Last run link copied (Visual: ${visualPreset}).`)"],
  ["copy daily link status confirms visual mode", "setStatus(`Daily challenge link copied (Visual: ${visualPreset}).`)"],
