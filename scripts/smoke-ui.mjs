...
const mountChecks = [
  ...
  ["wall orientation helper", "const wallRotation = (x:number,y:number)=>{"],
  ["wall orientation applied", "wall.setRotation(wallRotation(x,y))"],
  ["wall variation flip applied", "wall.setFlipX(((x + y) % 2) === 0)"],
