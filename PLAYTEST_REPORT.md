...
1. Add **A*** (or lightweight BFS-guided) monster path fallback.
2. Add one **player tactical tool** (dash, block, or bomb) with cooldown.
3. Add **death summary modal** with run stats and “restart with same seed”.
4. Add **floor modifiers** every 2 floors (e.g., “Brute-heavy”, “Low potion”).
