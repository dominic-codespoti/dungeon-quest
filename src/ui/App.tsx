    ...
    <div className='dq-shell'>
      <div className='dq-arena'>
        <div className='dq-center'>
          <div className='dq-center-head'>WASD/Arrows move · Shift+Dir dash · G guard · Q backstep · B bash · E interact · Space wait · R new run · T retry seed · C copy seed · M menu · ?/H help</div>
      ...
      {showHelp && (
        <div className='dq-overlay'>
          <div className='box'>
            ...
            <p>Interact: E · Wait: Space · New run: R · Retry seed: T · Copy seed: C · Main menu: M</p>
